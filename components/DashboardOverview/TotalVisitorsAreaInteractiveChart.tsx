...
export const TotalVisitorsAreaInteractiveChart: React.FC = () => {
  ...
  return (
    <Card className="w-full">
      <CardHeader className="border-primary-dark/10 dark:border-neutral/10 flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
