...
const chartData = [
  { browser: 'chrome', visitors: 460, fill: 'var(--color-chrome)' },
...
export const BrowserShareDonutChart: React.FC = () => {
    ...
    <Card className="flex flex-col">
                    ...
                    return (
                      ...
                      >
                        <tspan
                          x={viewBox.cx}
                          y={viewBox.cy}
                          className="fill-primary-dark dark:fill-primary-light text-3xl font-bold"
                        >
                        ...
                        <tspan
                          x={viewBox.cx}
                          y={(viewBox.cy || 0) + 24}
                          className="fill-secondary-dark dark:fill-neutral"
                        >
                          Visitors
                        </tspan>
                      </text>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="text:secondary-dark dark:text-secondary-light flex items-center gap-2 leading-none font-medium">
          Trending up by 4.7% this month <TrendingUp className="size-4" />
        </div>
        <div className="text-secondary-dark/50 dark:text-neutral leading-none">
          Showing browser usage for the last 6 months
        </div>
      </CardFooter>
    </Card>
  );
